...
class RelationalColumn(Column):
    ...
    def definition(self) -> 'ex.relational.definition.PositionedDataDefinition':
        ...
        if self.header.sheet_definition is not None:
            definition = self.header.sheet_definition.get_definition(self.column_based_index)
    ...
    def name(self):
        ...
        return _def.get_column_name(self.column_based_index) if _def is not None else None
    ...
    def value_type(self) -> str:
        ...
        t = _def.get_value_type_name(self.column_based_index)
        return t or super(RelationalColumn, self).value_type

    def __init__(self, header, column_based_index, buffer, offset):
        super(RelationalColumn, self).__init__(header, column_based_index, buffer, offset)
    ...
    def read(self, buffer: bytes, row: 'ex.datasheet.IDataRow', offset: int = None):
        ...
        return _def.convert(row, base_val, self.column_based_index) if _def is not None else base_val

    def __str__(self):
        return self.name or str(self.column_based_index)
